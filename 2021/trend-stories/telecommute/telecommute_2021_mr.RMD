...
output:
  ...
  includes:
    in_header: telecommute_2021.tex
  html_document:
    df_print: paged
fontsize: 12pt
---
...
# Create Image 
image1 <- image_read("photos/highway_times.jpg")
image2 <- image_read("photos/bus_loading_237.jpg")
image3 <- image_read("photos/peds_third_ave.jpg")
image4 <- image_read("photos/kitsap_ferry.jpg")
image5 <- image_read("photos/parked_cars.jpg")
...
```
<!--![](C:/Users/GGibson/OneDrive - Puget Sound Regional Council/Documents/GitHub/travel-studies/2021/trend-stories/telecommute/photos/commute_image_header.png){width=100%}-->
\begin{flushleft}
...
industry_work_travel_chart <- industry_by_work_loc_21 %>% 
  ...
  static_column_chart(t = .,
                      x = "industry_cond", y = "share",
                      fill = "workplace_travel",
                      moe = "share_moe",
                      href = 0.63,
                      hrefcl = "green",
...
# something is off with the numbers -> investigate results
# industry_race_chart <- industry_by_race_21 %>% 
#   filter(race_eth_poc == "POC") %>% 
#   mutate(industry_cond = fct_reorder(industry_cond, desc(share))) %>% 
#   static_column_chart(t = .,
#                       x = "industry_cond", y = "share",
#                       fill = "race_eth_poc",
