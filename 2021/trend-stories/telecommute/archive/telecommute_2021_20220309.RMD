...
```{r workplace, echo=FALSE, results=TRUE, warning=FALSE, fig.dim=c(6, 3.5)}
...
```{r telecommute_over_year, echo=FALSE, results=TRUE, warning=FALSE, fig.dim=c(6, 3)}
...
```{r times_per_week, echo=FALSE, results=TRUE, warning=FALSE, fig.dim=c(6, 3)}
...
```{r telecommute_gender, echo=FALSE, results=TRUE, warning=FALSE, fig.dim=c(6, 3)}
...
```{r telecommute_race, echo=FALSE, results=TRUE, warning=FALSE, fig.dim=c(6, 3)}
...
industry_gender_chart_ref <- industry_gender_chart +
  ggplot2::annotate("text", x = 1.9, y = 0.61, label = paste("Regional", "\n", "average"), hjust = 0, angle='0', color='#00A7A0')
...
industry_race_chart_ref <- industry_race_chart +
  ggplot2::annotate("text", x = 1.4, y = 0.50, label = "Regional average", angle='0', color='#00A7A0')
