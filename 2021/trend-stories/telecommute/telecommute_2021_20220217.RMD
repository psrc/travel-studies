...
travel_by_gender_21_wfh <- travel_by_gender_21 %>% 
  filter(workplace_travel=="Works at home")

travel_by_gender_chart2 <- static_column_chart(t = travel_by_gender_21_wfh,
                                              x = "gender_group", y = "share",
                                              fill = "workplace_travel",
                                              pos = "stack",  # fix bar stack issue
                                              moe = "share_moe",
...
Of those five industry groups that worked outside the home more than the regional average, two had greater proportions of female workers than the regional average (45\%; blue bar in chart below): Health Care, Social Services \& Childcare (73\%) and Personal Services (69\%).
...
industry_gender_chart_ref <- industry_gender_chart +
  ggplot2::annotate("text", x = 1.4, y = 0.57, label = "Regional average", angle='0', color='#00A7A0')

industry_gender_chart_ref
```

Of those five industry groups that worked outside the home more than the regional average, three had greater proportions of workers of color than the regional average (33\%; blue bar in chart below): Health Care, Social Services \& Childcare (42\%); Hospitality \& Retail (41\%); and Personal Services (39\%).
