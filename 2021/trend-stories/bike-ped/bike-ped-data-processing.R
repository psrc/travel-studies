...
write.csv(all_trips_summs_long,  paste0(output_dir,'/trips_by_purpose.csv'))
...
write.csv(mode_purp_long_walk,  paste0(output_dir,'/trips_by_purpose_walk.csv'))
...
write.csv(trips_by_mode_access,  paste0(output_dir,'/transit_access.csv'))
...
all_trips_summs_long<- rbind(all_trips_summs_2017_2019, all_trips_summs_2021) %>%
  mutate(survey = str_replace_all(survey, "_", "/"))
write.csv(all_trips_summs_long,  paste0(output_dir,'/walk_distance.csv'))
...
write.csv(wbfreq_summs_long, paste0(output_dir,'/walk_frequency.csv'))
...
write.csv(wbfreq_summs_long,  paste0(output_dir,'/bike_frequency.csv'))
...
for(i in seq(1, length(simple_groupings))){
  ...
  write.csv(walk_bike_summs_long,paste0(output_dir,'/',names(g),'_walk_mode_share.csv' ))
