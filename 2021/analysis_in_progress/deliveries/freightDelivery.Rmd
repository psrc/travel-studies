...
food_lifecycle_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = "hh_weight_2021_ABS", 
                    group_vars = c('lifecycle', 'delivery_food_all')) %>% 
  filter(lifecycle != 'Total')%>%
  filter(delivery_food_all != 'Total')%>%
  filter(delivery_food_all != 'No Delivery')%>%
...
grocery_lifecycle_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('lifecycle', 'delivery_grocery_all')) %>% 
  filter(lifecycle != 'Total')%>%
  filter(delivery_grocery_all != 'Total')%>%
  filter(delivery_grocery_all != 'No Delivery')%>%
...
lifecycles_grocery_test<- create_column_chart(t= all_grocery_lifecycle_17_21,
                                                  x="lifecycle", y="share",
                                                  f="survey",
                                            moe = "share_moe",
                                                  color="psrc_pairs",
...
pkgs_lifecycle_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('lifecycle', 'delivery_pkgs_all')) %>% 
  filter(lifecycle != 'Total')%>%
  filter(delivery_pkgs_all != 'Total')%>%
  filter(delivery_pkgs_all != 'No Delivery')%>%
...
work_lifecycle_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('lifecycle', 'delivery_work_all')) %>% 
  filter(lifecycle != 'Total')%>%
  filter(delivery_work_all != 'Total')%>%
  filter(delivery_work_all != 'No Delivery')%>%
...
deliveries_lifecycle_facet<- create_facet_bar_chart(t= all_deliveries_lifecycle_new,
                                                  ...
                                                  w.scales="fixed",
                                                  w.facet=4,
                                                  w.title="Home Deliveries or Services by Lifecycle",
                                                  w.sub.title="Share of Households on Average Weekday")
...
food_rgc_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('final_home_is_rgc', 'delivery_food_all')) %>% 
  filter(final_home_is_rgc != 'Total')%>%
  filter(delivery_food_all != 'Total')%>%
  filter(delivery_food_all != 'No Delivery')
...
grocery_rgc_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('final_home_is_rgc', 'delivery_grocery_all')) %>% 
  filter(final_home_is_rgc != 'Total')%>%
  filter(delivery_grocery_all != 'Total')%>%
  filter(delivery_grocery_all != 'No Delivery')
...
pkg_rgc_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('final_home_is_rgc', 'delivery_pkgs_all')) %>% 
  filter(final_home_is_rgc != 'Total')%>%
  filter(delivery_pkgs_all != 'Total')%>%
  filter(delivery_pkgs_all != 'No Delivery')
...
work_rgc_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('final_home_is_rgc', 'delivery_work_all')) %>% 
  filter(final_home_is_rgc != 'Total')%>%
  filter(delivery_work_all != 'Total')%>%
  filter(delivery_work_all != 'No Delivery')
...
food_hh_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('hhsize', 'delivery_food_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_food_all != 'Total')%>%
  filter(delivery_food_all != 'No Delivery')
...
grocery_hh_17 <- hhts_count(joined_df_deliveries_17, spec_wgt = 'day_weight_2017_v2021', 
                    group_vars = c('hhsize', 'delivery_grocery_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_grocery_all != 'Total')%>%
  filter(delivery_grocery_all != 'No Delivery')

grocery_hh_19 <- hhts_count(joined_df_deliveries_19, spec_wgt = 'day_weight_2019_v2021', 
                    group_vars = c('hhsize', 'delivery_grocery_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_grocery_all != 'Total')%>%
  filter(delivery_grocery_all != 'No Delivery')

grocery_hh_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('hhsize', 'delivery_grocery_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_grocery_all != 'Total')%>%
  filter(delivery_grocery_all != 'No Delivery')
...
grocery_hhsize_plot<- create_column_chart(t= all_grocery_hh_17_21,
                                                  x="hhsize", y="share",
                                                  f="survey",
                                                  moe = "share_moe",
                                                  color="psrc_pairs",
...
pkgs_hh_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('hhsize', 'delivery_pkgs_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_pkgs_all != 'Total')%>%
  filter(delivery_pkgs_all != 'No Delivery')
...
work_hh_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'hh_weight_2021_ABS', 
                    group_vars = c('hhsize', 'delivery_work_all')) %>% 
  filter(hhsize != 'Total')%>%
  filter(delivery_work_all != 'Total')%>%
  filter(delivery_work_all != 'No Delivery')
