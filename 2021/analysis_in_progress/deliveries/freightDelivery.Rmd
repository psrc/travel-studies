...
print(work_c)
```
```{r, facet wrap charts for all deliveries - pull from Mary's T:\2022September\Mary\EquityTracker\Transportation\HCTaccess_2020_5y_Elmer_CSV.Rmd code}

deliveries_facet1<- create_facet_bar_chart(t=allhct_indicator20,
                                                  w.x="quintile", w.y="wt_avg_miles",
                                                  f="quintile", g="aggregation",
                                                  w.color="blues_inc",
                                                  est.type ="number",
                                                  w.interactive="yes",
                                                  w.dec=2,
                                                  w.scales="fixed",
                                                  w.facet=2,
                                                  w.title="Share of Housholds Receiving Deliveries by Year)",
                                                  w.sub.title="2017, 2019, and 2021")

deliveries_facet1

# changing the aesthetic to make bars smaller 

allhct_indicator20_order <- allhct_indicator20 %>% 
  mutate(aggregation = fct_relevel(aggregation,
            "poc", "income", "lep", "disability", "older", "youth"))

deliveries_facet2<- create_facet_bar_chart(t=allhct_indicator20_order,
                                                  w.x="quintile", w.y="wt_avg_miles",
                                                  f="quintile", g="aggregation",
                                                  w.color="blues_inc",
                                                  est.type ="number",
