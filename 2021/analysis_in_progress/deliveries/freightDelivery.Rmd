...
share_plot_by_year(food_income_17_dichot, food_income_19_dichot, food_income_21_dichot,
                   'hhincome_dichot', 'delivery_food_all', 
                   'Food Deliveries to Households by Income')

share_plot_by_year2(food_income_17_dichot, food_income_19_dichot, food_income_21_dichot,
                   'survey', 'hhincome_dichot',  
                    'Food Deliveries by Year')

share_plot_by_cat(food_income_17_dichot, food_income_19_dichot, food_income_21_dichot, 
                  'hhincome_dichot', 'delivery_food_all',
                  'Income Categories')+
  psrc_style()+
  scale_fill_discrete_psrc("psrc_light")

count_plot_by_cat(food_income_17_dichot, food_income_19_dichot, food_income_21_dichot, 
                  'hhincome_dichot', 'delivery_food_all',
                  'Income Categories')+
  psrc_style()+
  scale_fill_discrete_psrc("psrc_light")
