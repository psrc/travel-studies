...
all_grocery_income_dichot_17_21 <- bind_rows(grocery_income_1719_dichot, grocery_income_21_dichot) %>%
  mutate(period = as.factor(survey))

# plot by year and by category

share_plot_by_year2_b <- function(dt1, dt2, grp_var, grp_var2, legend_name){
...
share_plot_by_year2_b(grocery_income_1719_dichot, grocery_income_21_dichot,
                   'survey', 'hhincome_dichot',  
