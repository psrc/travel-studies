...
table_food_17 <- hhts_count(joined_df_deliveries_17, spec_wgt = 'day_weight_2017_v2021', 
                    group_vars = c('delivery_food_all', 'hhincome_broad')) %>% 
  filter(hhincome_broad != 'Total')

table_food_19 <- hhts_count(joined_df_deliveries_19, spec_wgt = 'day_weight_2019_v2021', 
                    group_vars = c('delivery_food_all', 'hhincome_broad')) %>% 
  filter(hhincome_broad != 'Total')

table_food_21 <- hhts_count(joined_df_deliveries_21, spec_wgt = 'person_weight_2021_ABS_panel_adult', 
                    group_vars = c('delivery_food_all', 'hhincome_broad')) %>% 
  filter(hhincome_broad != 'Total')
