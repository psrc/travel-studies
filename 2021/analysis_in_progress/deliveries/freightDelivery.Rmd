...
```{r, sum checks to verify population numbers}
...
sum(joined_df_deliveries_1719$day_weight_2017_2019_v2021) ## unsure if this is the correct weight??
...
```{r, sum checks to verify household numbers}
...
```{r, sum checks to verify households for the individual years with their new weights}
sum(joined_df_deliveries_17$day_weight_2017_v2021)
sum(joined_df_deliveries_19$day_weight_2019_v2021)
sum(joined_df_deliveries_1719$day_weight_2017_2019_v2021)
...
count_food_1719 <- hhts_count(joined_df_deliveries_1719, group_vars = "delivery_food_all",
...
food_freq_separate <- rbind(count_food_1719, count_food_21)
