...
smp_commute_fx <- function(data, year) {
  ...
  assign(paste0('smp_commute_', year), temp_table)
}
...
all_commute_17_21 <- all_commute_17_21 %>% 
...
# freq(all_commute_17_21$hhadults_veh_grp)
# table(all_commute_17_21$survey, all_commute_17_21$numwork_veh_grp)
# table(all_commute_17_21$survey, all_commute_17_21$veh_num)
# table(all_commute_17_21$survey, all_commute_17_21$vehicle_count)
# table(all_commute_17_21$survey, all_commute_17_21$veh_num)
# table(all_commute_17_21$survey, all_commute_17_21$hhsize)
```
...
```{r}
race_com_cnt_2017 <- count_prep_fx(df_simp_2, 'final_home_is_rgc', 'commute_mode')

# race_com_cnt_2017$final_home_rgcnum <- factor(race_com_cnt_2017$final_home_rgcnum,
#                                                  levels=c("RGC",
#                                                           "Not RGC"))
                                                 
race_com_cnt_2017$final_home_is_rgc <- as.character(race_com_cnt_2017$final_home_is_rgc)

share_plot(race_com_cnt_2017, 'final_home_is_rgc', 'commute_mode', 'Regional Growth Center', 'Commute Mode and RGC: 2017')
```
\
\
