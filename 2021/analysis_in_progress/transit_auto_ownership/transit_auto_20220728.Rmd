...
```
Based on the z-score (`r z_0veh`), we **cannot** conclude that the values are different and that there was a change over time.
\
\
...
```
Based on the z-score (`r z_lessveh`), we **can** conclude that the values are different and that there was a change over time.
\
\
