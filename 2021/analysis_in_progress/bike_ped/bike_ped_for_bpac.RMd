...
psrc_pres <- add_cover_slide(p = psrc_pres,
                            p.title = "Puget Sound Regional Household Travel Survey Program",
                              p.mtg = "Bicycle and Pedestrian Access Committee",
...
psrc_pres <- add_transition_slide(p=psrc_pres,                                   p.title="Population Trends",

                                   
                                                                     p.img=system.file('extdata', 'uw-equity.png', package='psrcslides'))
...
```{r, include=TRUE}
p<-create_column_chart(t=trips_by_mode, w.x='mode_simple', w.y='share', f='year', w.moe='share_moe', est.type='percent', w.color = 'psrc_light')+
  xlab(as.character('Share of All Trips')) + ylab('Trip Mode')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y = element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=35))
  
  
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         p.title="Trip Mode Share by Adults", 
...
p<-create_column_chart(t=trips_by_mode_no_drive, w.x='mode_simple', w.y='share', f='year', w.moe='share_moe', est.type='percent', w.color = 'psrc_light') +
  xlab(as.character('Share of All Trips')) + ylab('Trip Mode')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y = element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=35))
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
...
```{r, include=TRUE}
p<-create_column_chart(t=trips_by_mode, w.x='mode_acc', w.y='share', f='year', w.moe='share_moe', est.type='percent', w.color = 'psrc_light')+
  xlab(as.character('Share of All Transit Trips')) + ylab('Transit Access Mode')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=35,color="#4C4C4C"))+theme(axis.text.y = element_text(size=50,color="#4C4C4C"))+theme(legend.text=element_text(size=35))
...
```{r, include=TRUE}
p<-create_column_chart(t=trips_by_mode, w.x='mode_acc_walk', w.y='share', f='year', w.moe='share_moe', est.type='percent', w.color = 'psrc_light')+
  xlab(as.character('Share of All Transit Trips')) + ylab('Transit Access Mode')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=35))
...
p<-create_bar_chart(t=trips_purp , w.x='simple_purpose', w.y='share', f='survey', w.moe='share_moe', est.type='percent', w.color='psrc_light')+scale_fill_manual(values = psrc_colors$psrc_light[3:4])+
  ylab('Share of All Trips') + xlab('Purpose')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p)
...
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
  ...
  p2<-create_bar_chart(t=all_trips_summs_2021_mode , w.x='simple_purpose', w.y='share', f='mode_simple', w.moe='share_moe', est.type='percent', w.color='psrc_light') +
  ylab('Share of All Trips') + xlab('Purpose')+scale_fill_manual(values = psrc_colors$psrc_light[5:6])+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
...
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
  ...
  print(p2)
  p3<-create_bar_chart(mode_purp_long_walk, w.x='simple_purpose', w.y='share', f='survey', w.moe='share_moe', est.type='percent', w.color='psrc_light')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))  +
  ylab('Share of All Trips') + xlab('Purpose')+coord_flip()+scale_fill_manual(values = psrc_colors$psrc_light[5:6])+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  ...
  psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         ...
                                         p.chart=p3) 
    p4<-create_bar_chart(mode_purp_long_bike, w.x='simple_purpose', w.y='share', f='survey', w.moe='share_moe', est.type='percent', w.color='psrc_light')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))  +
  ylab('Share of All Trips') + xlab('Purpose')+coord_flip()+scale_fill_manual(values = psrc_colors$psrc_light[5:6])+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  ...
  print(p4)
#print(psrc_pres, target = "C:/Users/schildress/OneDrive - Puget Sound Regional Council/Documents/hhts_bpac_sept22.pptx")
...
trips_purp<-all_trips_summs_long
p<-create_bar_chart(t=all_trips_summs_long , w.x='mode_simple', w.y='trip_path_distance_median', f='survey', w.moe='trip_path_distance_median_moe', est.type='number', w.color = 'psrc_pairs')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+
  ylab(as.character('Trip Path Distance')) + xlab("Mode")+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(legend.text=element_text(size=35))
  print(p)
...
```{r}
  ...
  xlab(as.character('Walk Frequency')) + ylab('Share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p1)
...
if(cat_name=='hhincome_100_f'){
 ...
 wbfreq_summs_2021$hhincome_100_f=factor(wbfreq_summs_2021$hhincome_100_f, levels=c("Prefer not to answer",  "$100,000 or more","$75,000-$99,999", "$50,000-$74,999" ,"$25,000-$49,999" , "Under $25,000"  ))
  ...
  xlab(as.character(g[cat_name])) + ylab('Share who Go for a Walk Sometimes')+theme(axis.text.x = element_text(size=35,color="#4C4C4C")) +theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p0)
  ...
  xlab(as.character(g[cat_name])) + ylab('Share who Go for a Walk Sometimes')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p1)
...
for(i in seq(1, length(simple_groupings))){
 ...
 # p0<-create_bar_chart(t=Walk_bike_summs_2021_only , w.x=cat_name, w.y='share',  f=cat_name,w.moe='share_moe', est.type='percent', #w.color='psrc_light')+ t#heme(axis.text.x = element_text(size=35,color="#4C4C4C"))+coord_flip()
  ...
  xlab(as.character(g[cat_name])) + ylab('Walk mode share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p0)
...
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
 ...
 # p<-create_facet_bar_chart(t=Walk_bike_summs_long , w.x=cat_name, w.y='share', f='non_motorized_mode', g='survey', w.moe='share_moe', est.type='percent', w.color = 'psrc_light')+ theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+coord_flip()
...
for(i in seq(1, length(simple_groupings))){
 ...
 # p0<-create_bar_chart(t=Walk_bike_summs_2021_only , w.x=cat_name, w.y='share',  f=cat_name,w.moe='share_moe', est.type='percent', #w.color='psrc_light')+ t#heme(axis.text.x = element_text(size=35,color="#4C4C4C"))+coord_flip()
  ...
  xlab(as.character(g[cat_name])) + ylab('Transit Access Walk Mode Share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p0)
...
trips_purp<-all_trips_summs_long
p<-create_bar_chart(t=all_trips_summs_long , w.x='mode_simple', w.y='trip_path_distance_median', f='survey', w.moe='trip_path_distance_median_moe', est.type='number', w.color = 'psrc_pairs')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+
  ylab(as.character('Trip Path Distance')) + xlab("Mode")+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))
  print(p)
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         p.title="Walk, Bike, and Transit Shares", 
                                         p.caption=paste0("2017/2019 vs 2021"), 
...
p<-ggplot(all_Walks, aes(x=trip_path_distance, color=survey)) + geom_histogram(bins=20, aes(weight=trip_wt, fill=survey), alpha=0.5, position= position_dodge(width=0.2))+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+
  ylab(as.character('Daily Walking Trips')) + xlab("Distance (miles)")+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))
...
```{r}
  ...
  xlab(as.character('Bike Frequency')) + ylab('Share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+theme(legend.text=element_text(size=35))
  print(p1)
...
```{r}
  ...
  xlab(as.character('Bike Frequency')) + ylab('Share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+scale_fill_manual(values = psrc_colors$psrc_pairs[c(4,1)])
  print(p1)
  psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         p.title="Walk, Bike, and Transit Shares", 
                                         p.caption=paste0("2017/2019 vs 2021"), 
...
if(cat_name=='hhincome_100_f'){
 ...
 wbfreq_summs_2021$hhincome_100_f=factor(wbfreq_summs_2021$hhincome_100_f, levels=c("Prefer not to answer",  "$100,000 or more","$75,000-$99,999", "$50,000-$74,999" ,"$25,000-$49,999" , "Under $25,000"  ))
  ...
  xlab(as.character(g[cat_name])) + ylab('Share who Bike Sometimes')+theme(axis.text.x = element_text(size=35,color="#4C4C4C")) +theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+scale_fill_manual(values = psrc_colors$psrc_pairs[1])+theme(legend.text=element_text(size=35))
  print(p0)
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         p.title="Walk, Bike, and Transit Shares", 
                                         p.caption=paste0("2017/2019 vs 2021"), 
  ...
  xlab(as.character(g[cat_name])) + ylab('Share who Bike Sometimes')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()+scale_fill_manual(values = psrc_colors$psrc_pairs[c(4,1)])+theme(legend.text=element_text(size=35))
  print(p1)
...
for(i in seq(1, length(simple_groupings))){
 ...
 # p0<-create_bar_chart(t=Walk_bike_summs_2021_only , w.x=cat_name, w.y='share',  f=cat_name,w.moe='share_moe', est.type='percent', w.color='psrc_light')+ t#heme(axis.text.x = element_text(size=35,color="#4C4C4C"))+coord_flip()
   ...
   p0<-create_bar_chart(t=Walk_bike_summs_2021 , w.x=cat_name, w.y='share', f='mode_simple', w.moe='share_moe', est.type='percent', w.color = 'psrc_light', w.interactive=TRUE) + 
  xlab(as.character(g[cat_name])) + ylab('Bike mode share')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+coord_flip()
  print(p0)
psrc_pres <- add_bullet_plus_chart_slide (p=psrc_pres, 
                                         p.title="Walk, Bike, and Transit Shares", 
                                         p.caption=paste0("2017/2019 vs 2021"), 
...
ggplot(all_Walks, aes(x=trip_path_distance, color=survey)) + geom_histogram(position=position_dodge(0.3), aes(weight=trip_wt, fill=survey), alpha=0.5, bins=15)+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+
  ylab(as.character('Daily Biking Trips')) + xlab("Distance (miles)")+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))
...
trips_purp<-all_trips_summs_long
p<-create_bar_chart(t=all_trips_summs_long , w.x='mode_simple', w.y='trip_path_distance_median', f='survey', w.moe='trip_path_distance_median_moe', est.type='number', w.color = 'psrc_pairs')+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+
  ylab(as.character('Trip Path Distance Median (miles)')) + xlab("Mode")+theme(axis.text.x = element_text(size=35,color="#4C4C4C"))+ theme(axis.title.x = element_text(size=50,color="#4C4C4C"))+theme(axis.title.y = element_text(size=50,color="#4C4C4C"))
  print(p)
