...
trip_data$lifecycle2 =factor(trip_data$lifecycle2, levels= c('Household has kids', 'Under 35 years, no kids', '35-64', '65 years or older' ))
trip_data
...
print(work_trips_households_long)
 ...
 work_trips_households_long_total<- bind_rows(work_trips_hh_17, work_trips_hh_19, work_trips_hh_21) %>%mutate(survey_trips = str_replace_all(survey_trips, "_", ""))%>%filter(!!rlang::sym(cat_name)=='Total')
   ...
   p<-static_column_chart(t= work_trips_households_long , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
...
print(shop_trips_households_long)
 ...
 print(shop_trips_households_long)
   ...
   p<-static_column_chart(t= shop_trips_households_long , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
  xlab('Household Characteristic') + ylab('Shopping Trips per HH')+theme(axis.title.x = element_text(size=25,color="#4C4C4C"))+theme(axis.text.x = element_text(size=15,color="#4C4C4C"))+theme(axis.title.y = element_text(size=25,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=25))
   
    p1<-static_column_chart(t= shop_trips_households_long_total , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
  xlab('All Households') + ylab('Shopping Trips per HH')+theme(axis.title.x = element_text(size=15,color="#4C4C4C"))+theme(axis.text.x = element_text(size=25,color="#4C4C4C"))+theme(axis.title.y = element_text(size=25,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=25))
...
print(meal_trips_households_long)
 ...
 meal_trips_households_long_total<- bind_rows(meal_trips_hh_17, meal_trips_hh_19, meal_trips_hh_21) %>%mutate(survey_trips = str_replace_all(survey_trips, "_", ""))%>%filter(!!rlang::sym(cat_name)=='Total')
   ...
   p<-static_column_chart(t= meal_trips_households_long , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
  xlab('Household Characteristic') + ylab('Meal Trips per HH')+theme(axis.title.x = element_text(size=25,color="#4C4C4C"))+theme(axis.text.x = element_text(size=25,color="#4C4C4C"))+theme(axis.title.y = element_text(size=25,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=25))
    ...
    p1<-static_column_chart(t= meal_trips_households_long_total , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
...
all_trips_hh_21<-all_trips_per_hh_total(trip_data_21, household_data_21,'trip_adult_weight_2021', 'hh_weight_2021')
 ...
 all_trips_households_long<- bind_rows(all_trips_hh_17, all_trips_hh_19, all_trips_hh_21)%>%filter(simple_purpose != 'Total')
 
  p0<-create_facet_bar_chart(t= all_trips_households_long , w.x='survey', w.y='trips_per_household', f='survey', g='simple_purpose', w.moe='moe_trips_household', est.type='number', w.color = 'psrc_light', w.scale='fixed') + 
  xlab('Year') + ylab('Trips per Household')+theme(axis.title.x = element_text(size=15,color="#4C4C4C"))+theme(axis.text.x = element_text(size=15,color="#4C4C4C"))+theme(axis.title.y = element_text(size=15,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=15,color="#4C4C4C"))+theme(legend.text=element_text(size=15))
 p0
```
...
print(all_trips_households_long)
 ...
 all_trips_households_long_total<- bind_rows(all_trips_hh_17, all_trips_hh_19, all_trips_hh_21) %>%mutate(survey_trips = str_replace_all(survey_trips, "_", ""))%>%filter(rlang::sym(cat_name)=='Total')
   ...
   p<-static_column_chart(t= all_trips_households_long , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
  xlab('Household Characteristic') + ylab('All Trips per HH')+theme(axis.title.x = element_text(size=25,color="#4C4C4C"))+theme(axis.text.x = element_text(size=25,color="#4C4C4C"))+theme(axis.title.y = element_text(size=25,color="#4C4C4C"))+theme(axis.text.y.left =   element_text(size=35,color="#4C4C4C"))+theme(legend.text=element_text(size=25))
    ...
    p1<-static_column_chart(t= all_trips_households_long_total , x=cat_name, y='trips_per_household', f='survey_trips', moe='moe_trips_household', est='number', color = 'psrc_light') + 
