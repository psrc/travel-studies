...
household_data_17_19_21<-rbind(household_data_17, household_data_19, household_data_21)%>%
  mutate(as.factor(household_data_17_19_21$broadband))
```
...
household_data<-household_data%>%
  ...
  mutate(broadband=factor(case_when(broadband == 'Broadband service is available where I live, but I DO NOT have broadband service at my residence'| 
