...
#household_data$hhincome_detailed2 = factor(household_data$hhincome_detailed2, 
...
deliv_model_income<-glm(formula= delivery_pkg~hhincome_detailed2, family=binomial(), data=hh_shop_tract2)
