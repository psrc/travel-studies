...
deliv_model<-glm(formula= delivery_pkg~hhincome_detailed,family=binomial(), data=hh_shop_tract)
summary(deliv_model)

deliv_model_sig<-glm(formula= delivery_pkg~hhincome_detailed,family=binomial(), data=hh_shop_tract)
