...
trip_data_21<- get_hhts("2021", "t", vars=trip_vars)%>%filter(age_category!='Under 18 years' & sample_source=='ABS')%>%dplyr::select(-c(trip_weight_2021, trip_respondent_weight_2021))
...
unique(hh_shop_tract_21$numchildren)
```
