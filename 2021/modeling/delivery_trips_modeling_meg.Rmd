...
deliv_model<-glm(formula= delivery_food_both~hhincome_detailed2+lifecycle2+final_home_is_rgc+hh_race_apoc+poor_english+severe_cost_burdened+poverty_200+prox_high_inc+transit_qt_mile+dist_super+ln_jobs_auto_30+rent_own+NoVehicles+broadband2,family=binomial(), data=hh_shop_tract1)
summary(deliv_model)
...
hh_shop_tract_17_19$hhincome_detailed2 <- factor(hh_shop_tract_17_19$hhincome_detailed2, levels = c("$100,000-$149,999", "Under $50,000", "$50,000-$74,999", 
...
hh_shop_tract_17_19$numworkers <-  factor(hh_shop_tract_17_19$numworkers, levels = c("No workers", "1 worker", "2 workers", "3 or more workers"))
