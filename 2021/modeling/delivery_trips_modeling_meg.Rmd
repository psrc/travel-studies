...
hh_shop_tract_17$hhincome_detailed2 <- factor(hh_shop_tract_17$hhincome_detailed2, levels = c("$100,000-$149,999", "Under $50,000", "$50,000-$74,999", 
                                                                                              "$75,000-$99,999", "$150,000-$199,999", "$200,000-$249,999",
                                                                                              "$250,000 or more"))
hh_shop_tract_17$numchildren_bin <-  factor(hh_shop_tract_17$numchildren_bin, levels = c("None", "Has kids"))
hh_shop_tract_17$disability <-  factor(hh_shop_tract_17$disability, levels = c("No", "Yes"))
hh_shop_tract_17$numworkers <-  factor(hh_shop_tract_17$numworkers, levels = c("No workers", "1 worker", "2 workers", "3 or more workers"))
hh_shop_tract_17$hh_race_apoc <-  factor(hh_shop_tract_17$hh_race_apoc, levels = c("Non-POC", "Asian POC", "Non-Asian POC"))
...
hh_shop_tract_21$hhincome_detailed2 <- factor(hh_shop_tract_21$hhincome_detailed2, levels = c("$100,000-$149,999", "Under $50,000", "$50,000-$74,999", 
                                                                                              "$75,000-$99,999", "$150,000-$199,999", "$200,000-$249,999",
                                                                                              "$250,000 or more"))
...
hh_shop_tract_21$numworkers <-  factor(hh_shop_tract_21$numworkers, levels = c("No workers", "1 worker", "2 workers", "3 or more workers"))
...
table(hh_shop_tract_17$delivery_pkgs_all)
...
deliv_model_income_17<-glm(formula = delivery_food ~ hhincome_detailed2,
                        family=binomial(), 
                        data=hh_shop_tract_17)

deliv_model_income_19<-glm(formula = delivery_food ~ hhincome_detailed2,
                        family=binomial(), 
                        data=hh_shop_tract_19)

deliv_model_income_21<-glm(formula = delivery_food ~ hhincome_detailed2,
                        family=binomial(), 
                        data=hh_shop_tract_21)

summary(deliv_model_income_17)
summary(deliv_model_income_19)
summary(deliv_model_income_21)

plot_summs(deliv_model_income_17, scale=TRUE)
...
deliv_model_lifecycle_17<-glm(formula= delivery_food~numchildren_bin, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_lifecycle_19<-glm(formula= delivery_food~numchildren_bin, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_lifecycle_21<-glm(formula= delivery_food~numchildren_bin, 
                           family=binomial(), 
                           data=hh_shop_tract_21)

summary(deliv_model_lifecycle_17)
summary(deliv_model_lifecycle_19)
summary(deliv_model_lifecycle_21)

plot_summs(deliv_model_lifecycle_17, scale=TRUE)
plot_summs(deliv_model_lifecycle_19, scale=TRUE)
plot_summs(deliv_model_lifecycle_21, scale=TRUE)

#table(hh_shop_tract_17$numchildren_bin)
```

```{r, income and kids}
# no kids and 100,000-149,999

deliv_model_combo_17<-glm(formula= delivery_food~numchildren_bin + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~numchildren_bin + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~numchildren_bin + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_21)

summary(deliv_model_combo_17)
summary(deliv_model_combo_19)
summary(deliv_model_combo_21)

plot_summs(deliv_model_combo_17, scale=TRUE)
...
deliv_model_combo_17<-glm(formula= delivery_food~disability, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~disability, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~disability, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
deliv_model_combo_17<-glm(formula= delivery_food~disability + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~disability + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~disability + hhincome_detailed2, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
deliv_model_combo_17<-glm(formula= delivery_food~numworkers, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~numworkers, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~numworkers, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
deliv_model_combo_17<-glm(formula= delivery_food~shop_trips, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~shop_trips, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~shop_trips, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
deliv_model_combo_17<-glm(formula= delivery_food~final_home_is_rgc, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~final_home_is_rgc, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~final_home_is_rgc, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
table(hh_shop_tract_17$hh_race_apoc)

deliv_model_combo_17<-glm(formula= delivery_food~hh_race_apoc, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~hh_race_apoc, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~hh_race_apoc, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
```{r, broadband}
# no answer for 2017 or 2019, default is No

table(hh_shop_tract_21$broadband2)

deliv_model_combo_21<-glm(formula= delivery_food~broadband2, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
table(hh_shop_tract_17$mobile_device)

deliv_model_combo_17<-glm(formula= delivery_food~mobile_device, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~mobile_device, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~mobile_device, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
...
table(hh_shop_tract_17$rent_own)

deliv_model_combo_17<-glm(formula= delivery_food~rent_own, 
                           family=binomial(), 
                           data=hh_shop_tract_17)
deliv_model_combo_19<-glm(formula= delivery_food~rent_own, 
                           family=binomial(), 
                           data=hh_shop_tract_19)
deliv_model_combo_21<-glm(formula= delivery_food~rent_own, 
                           family=binomial(), 
                           data=hh_shop_tract_21)
