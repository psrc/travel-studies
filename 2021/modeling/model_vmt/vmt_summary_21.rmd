...
```{r}
vmt_mean_group_1<-persons_vmt_new%>%
group_by(hhgroup)%>%
...
```{r}
vmt_model__small_interest_21<-lm(ln_vmt_day ~ employment+vehicle_count_simple+license+commute_freq+telecommute_freq_simple +transit_ben + compressed_ben + flextime_ben +  survey_year_factor+ log(1 + jobs_auto/10000) + 
