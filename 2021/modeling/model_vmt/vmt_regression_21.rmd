...
vmt_model_best_fit_21<-lm(ln_vmt_day ~ employment + inc100k + vehicle_count_simple + 
    ...
    student + license + telecommute_freq_simple + Kitsap_home + 
    transit_ben + compressed_ben + flextime_ben + rent_own + 
    delivery_work_all + log(1 + jobs_transit/10000) + log(1 + 
    pharmacy) + log(1 + park) + survey_year_factor + inc100k:survey_year_factor + 
...
```{r}
vmt_model__small_interest_21<-lm(ln_vmt_day ~ employment+vehicle_count_simple+license+telecommute_freq_simple +transit_ben + compressed_ben + flextime_ben + 
