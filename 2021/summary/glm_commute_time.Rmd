...
commute_vars<- c('commute_auto_distance', 'commute_auto_time')
demo_vars<- c('industry', 'age', 'gender', 'jobs_count', 'employment', 'worker', 'workplace', 'vehicle_count',
                  'commute_mode', 'commute_freq', 'race_eth_broad', 'res_factors_30min', 'res_factors_afford', 'res_factors_school', 'work_lat', 'work_lng', 'res_factors_hwy','student', 'sample_county', 'commute_dur', 'work_county',
                  'res_factors_transit', 'numworkers', 'final_home_puma10', 'hhsize', 'lifecycle', 'hhincome_broad', 'car_share', 'rent_own', 'res_dur', 'res_type', 'broadband' , 'prev_res_factors_more_space', 'workplace_pre_covid', 'commute_freq_pre_covid', 'commute_mode_pre_covid', 'employment_change_employer',  'employment_change_location')


all_vars<- get_hhts(survey= '2021',
         level = 'p',
         vars = c(commute_vars, demo_vars))
