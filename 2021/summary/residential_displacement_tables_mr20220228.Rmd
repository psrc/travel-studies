...
counts_2019_2021_2<-rbind(hh_2019_counts, hh_2021_counts) %>% 
  # mutate(type="survey") %>% 
  select(-c(share, share_moe, sample_size)) %>% 
...
movers_2019_2021_counts_2<-rbind(movers_hh_2019_counts, movers_hh_2021_counts) %>% 
  # mutate(type="movers") %>% 
  select(-c(res_dur, share, share_moe, sample_size)) %>% 
...
displaced_2019_2021_counts_2<-rbind(displaced_hh_2019_counts, displaced_hh_2021_counts) %>% 
  ...
  select(-c(prev_res_factors_displaced, share, share_moe, sample_size)) %>% 
...
```{r}
# conbine datasets into one dataframe
