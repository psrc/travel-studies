...
gender_tcf <- function(table, plot.source.year, plot.caption = plot.caption, palette, hjust = .5, vjust = 1.2, angle = 45) {
...
gender_tcf(plot.source.year = '2017/19, 2021', plot.caption = plot.caption.01, palette = "Paired", hjust = .5, vjust = 0, angle = 0)
```
...
df %>% 
  ...
  gender_tcf(plot.source.year = '2017, 2019, 2017/19, 2021', plot.caption = plot.caption.01, palette = "Set3", hjust = .5, vjust = 0, angle = 0)
...
df_simple %>% 
  filter(tc_freq_group != 'Never / None') %>% 
  filter(gender_group != 'Prefer not to answer / Another') %>% 
  gender_tcf(plot.source.year = '2017, 2019, 2017/19, 2021', plot.caption = plot.caption.02, palette = "Set3", hjust = .5, vjust = 0, angle = 0)
```
