...
## example workflow (see [Topsheet](https://github.com/psrc/travel-studies/tree/master/2025/hts_summary/Analysis/Topsheet))

1.  create a topic folder in [the Analysis folder](https://github.com/psrc/travel-studies/tree/master/2025/hts_summary/Analysis)
...
3.  to render your analysis scripts into a [Quarto Book](https://quarto.org/docs/books/) locally
    -   you will need at least two files: [\_quarto.yml](https://github.com/psrc/travel-studies/blob/master/2025/hts_summary/Analysis/Topsheet/_quarto.yml) and [index.qmd](https://github.com/psrc/travel-studies/blob/master/2025/hts_summary/Analysis/Topsheet/index.qmd)
