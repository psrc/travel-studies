...
```{r}
transit_workers_share<- transit_workers_join%>%mutate(transit_share=estimate_home/estimate_all)
```
...
create_tract_map_transit <- function(census.tbl, census.lyr,
  ...
  labels <- paste0( "Transit Share: ", percent(c.layer$transit_share, accuracy=1)) %>% 
