...
hh <- get_query(sql= "select household_id as hh_id, survey_year, hhincome_broad, home_county, hh_weight
  ...
  mutate(hhincome = case_when(hhincome_broad %in% c("Under $25,000","$25,000-$49,999","$50,000-$74,999")~"Under $75,000",
         ...
         hhincome2 = case_when(hhincome_broad %in% c("Under $25,000","$25,000-$49,999")~"Under $50,000",
                               hhincome_broad %in% c("$50,000-$74,999","$75,000-$99,999","$100,000 or more","$100,000-$199,000",
...
test <- get_hts_summary(hts_hh_day, 
  ...
  mutate(hhincome = factor(hhincome,levels=c("Under $75,000","$75,000+")))
...
test <- get_hts_summary(hts_hh_day, 
  ...
  mutate(hhincome5 = factor(hhincome5,levels=c("Under $50,000","$50,000-$99,999","$100,000 or more","$100,000-$199,000", "$200,000 or more" )))
