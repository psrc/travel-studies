...
person_id, workplace, telecommute_freq, survey_year, person_weight, gender, age, employment, sexuality, industry,office_available, commute_freq, education, work_lat, work_lng , work_rgcname, work_jurisdiction, work_county
...
value<- c(0,1,2,3,4,5)
label=c('Not Worker', 'Fully at Home-Self employed', 'Fully at Home-Outside Employer', 'Hybrid', 'Outside Home- Self employed', 'Fully in Person')
...
person<-person%>%mutate(telecommute_status=
        case_when(workplace %in%c('Missing: Skip logic', "Missing: Skip Logic") 
                  ...
                  (workplace=='At home (telecommute or self-employed with home office)' & employment=='Self-employed' ) ~ 'Fully at Home-Self employed',
                  (workplace=='At home (telecommute or self-employed with home office)' & employment!='Self-employed' ~ 'Fully at Home-Outside Employer'),
                  employment=='Self-employed' ~ 'Outside home-Self employed',
