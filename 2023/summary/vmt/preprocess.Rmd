...
```{r }
hh<- get_query(sql= "select  household_id as hh_id, hhincome_broad,home_jurisdiction, home_county, hh_weight,vehicle_count, home_rgcname, home_lat, home_lng, survey_year, hhincome_detailed
...
trip<- get_query(sql= "select trip_id, household_id as hh_id, day_id,mode_1, mode_2, mode_3, mode_4,
person_id, dest_purpose, survey_year, trip_weight, distance_miles, mode_characterization, travelers_total 
