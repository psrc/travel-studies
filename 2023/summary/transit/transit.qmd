...
No_veh <- mode_summary_veh %>% 
    filter(vehicle_ownership == "Not a vehicle owner", mode_simple != "NA")
...
transitbyveh_chart <- static_line_chart(transit_by_veh,
...
noveh_chart_mode <- static_line_chart(No_veh,
                    x = "survey_year", y = "prop", fill = "mode_simple",
