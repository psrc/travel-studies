...
```{r}
static_column_chart(t=workers_commute_share_work_trips, y='share_wtd_wrkers', x='commute_freq_simple', fill='WorkGrp', color=  "pgnobgy_10", ylabel='Share of Workers', xlabel='Commute Frequency' ) + theme(axis.text.x=element_text(size=14), axis.text.y=element_text(size=14),legend.text = element_text(size=14), axis.title.y=element_text(size=20), axis.title.x=element_text(size=20))
```
...
```{r}
static_column_chart(t=workers_freq_share_work_trips, y='share_wtd_wrkers', x='telecommute_freq_simple', fill='WorkGrp', color=  "pgnobgy_10" ) + theme(axis.text.x=element_text(size=14), axis.text.y=element_text(size=14),legend.text = element_text(size=14), axis.title.y=element_text(size=20), axis.title.x=element_text(size=20))
```
