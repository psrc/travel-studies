...
telecommute_summary_2<-telecommute_status_2$summary$wtd%>%mutate(telecommute_status_broad=factor(telecommute_status_broad, levels=c('Fully In Person', 'Mostly In Person', 'Mostly Remote', 'Fully Remote')))
