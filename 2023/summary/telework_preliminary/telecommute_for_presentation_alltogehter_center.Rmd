...
static<-static_facet_column_chart(telecommute_summary, y='prop', x='work_rgc_cat', fill='survey_year', facet='telecommute_status') + theme(axis.text.x=element_text(size=14), axis.text.y=element_text(size=14),legend.text = element_text(size=14), axis.title.y=element_text(size=20), axis.title.x=element_text(size=20))
static
