...
static_line_chart(filter(disp_allrace, 
                    ...
                    ylabel = "% of respondents", xlabel = "Household race", 
                    title = paste0("Displacement by Household Race")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_4race, 
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "hh_race_category_4",
                    ylabel = "% of respondents", xlabel = "Household race", 
                    title = paste0("Displacement by Household Race")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
...
# All years
static_line_chart(filter(disp_3race,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "hh_race_category_3",
                    ylabel = "% of respondents", xlabel = "Household race", 
                    title = paste0("Displacement by Household Race")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
...
static_column_chart(filter(disp_2race, survey_year == focus_year, 
                    ...
                    ylabel = "% of respondents", xlabel = "Household race", 
                    title = paste0("Displacement by Household Race"),
                    moe = "prop_moe") + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_2race,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "hh_race_category_2",
                    ylabel = "% of respondents", xlabel = "Household race", 
...
# All years
static_line_chart(filter(disp_hhsize,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "hhsize_bin4",
                    ylabel = "% of respondents", xlabel = "Household size", 
                    title = paste0("Displacement by Household Size")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_children,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "numchildren_simp",
                    ylabel = "% of respondents", xlabel = "Number of Children", 
                    title = paste0("Displacement by Number of Children")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_inc,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "hhincome_bin5",
                    ylabel = "% of respondents", xlabel = "Household Income", 
                    title = paste0("Displacement by Household Income")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_veh, 
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "vehicle_count_bin4",
                    ylabel = "% of respondents", xlabel = "Number of Vehicles", 
                    title = paste0("Displacement by Household Vehicles")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_edu,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "edu_hh_max",
                    ylabel = "% of respondents", xlabel = "Education Attainment", 
                    title = paste0("Displacement by Household's Highest Education")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# Calculate a categorical summary, i.e. count/share
disp_workers_4 <- psrc_hts_stat(hts_data, 
                                analysis_unit="hh", 
                                group_vars=c("num_workers_4bin", "displaced"))

focus_year <- 2023

# view data
head(dplyr::select(disp_workers_4[survey_year==focus_year],
                   -c(survey_year)))

# create chart
static_column_chart(filter(disp_workers_4, 
                           survey_year == focus_year, 
                           !is.na(num_workers_4bin),
                           displaced=="Displaced"),
...
# All years
static_line_chart(filter(disp_workers_4, 
                           !is.na(num_workers_4bin),
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "num_workers_4bin",
                    ylabel = "% of respondents", xlabel = "Workers in Household", 
                    title = paste0("Displacement by Household Employment")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
static_column_chart(filter(disp_worker, 
                    ...
                    ylabel = "% of respondents", xlabel = "Workers:Adults in Household", 
                    title = paste0("Displacement by Household Workers:Adults (", focus_year, ")"),
                    moe = "prop_moe") + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_worker, 
                           !is.na(adult_workers),
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "adult_workers",
                    ylabel = "% of respondents", xlabel = "Workers:Adults in Household", 
                    title = paste0("Displacement by Household Workers:Adults")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_prev_tenure,  
                           !is.na(prev_rent_own_bin2),
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "prev_rent_own_bin2",
                    ylabel = "% of respondents", xlabel = "Previous Housing Tenure", 
                    title = paste0("Displacement by Previous Housing Tenure")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_current_tenure,
                           !is.na(rent_own_bin2),
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "rent_own_bin2",
                    ylabel = "% of respondents", xlabel = "Current Housing Tenure", 
                    title = paste0("Displacement by Housing Tenure")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_tenure_transition,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "res_tenure_transition",
                    ylabel = "% of respondents", xlabel = "Change in Housing Tenure", 
                    title = paste0("Displacement by Change in Housing Tenure")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
table(hts_data$hh$prev_res_type, hts_data$hh$survey_year)
...
static_line_chart(filter(disp_prev_type,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "prev_res_type",
                    ylabel = "% of respondents", xlabel = "Previous Housing Type", 
                    title = paste0("Displacement by Housing Type")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_prev_type_simple, 
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "prev_res_type_simp",
                    ylabel = "% of respondents", xlabel = "Previous Housing Type", 
                    title = paste0("Displacement by Previous Housing Type")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_type_simple,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "res_type_simp",
                    ylabel = "% of respondents", xlabel = "Current Housing Type", 
                    title = paste0("Displacement by Current Housing Type")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_type_transition,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "res_type_transition",
                    ylabel = "% of respondents", xlabel = "Change in Housing Type", 
                    title = paste0("Displacement by Change in Housing Type")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_rgc,
                         displaced=="Displaced",
                         RGC=="RGC"),
                  x = "survey_year", y = "prop", fill = "res_type_simp",
                  #facet="RGC", pos="stack",
                  ylabel = "% of respondents", xlabel = "Home Location", 
                  title = paste0("Displacement by Location in RGC")) + theme(
                    axis.text.x = element_text(size = 14),
                    axis.text.y = element_text(size = 14),
                    axis.title.y = element_text(size = 20),
                    axis.title.x = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_county,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "home_county",
                    ylabel = "% of respondents", #xlabel = "Home County", 
                    title = paste0("Displacement by County")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
                      axis.title.x = element_text(size = 20),
...
home_loc <- hts_data$hh %>%
  st_as_sf(coords = c("home_lng", "home_lat"), 
           crs = 4326) %>% 
  select(hh_id, geometry)

hh <- st_intersection(home_loc, region_geo) %>%
  select(hh_id, cnty_name, feat_type, juris, class_desc)
...
# Calculate a categorical summary, i.e. count/share - not working
disp_reggeo <- psrc_hts_stat(hts_data,
                               analysis_unit="hh",
                               group_vars=c("class_desc", "displaced"))

focus_year <- 2023

# create chart
static_column_chart(filter(disp_reggeo, 
                           survey_year == focus_year,
                           displaced=="Displaced"),
                    x = "displaced", y = "prop", fill = "class_desc",
                    ylabel = "% of respondents",
                    title = paste0("Displacement by Regional Geography (", focus_year, ")"),
                    moe = "prop_moe") + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
                      axis.title.y = element_text(size = 20),
...
# All years
static_line_chart(filter(disp_reggeo,
                         displaced=="Displaced"),
                  x = "survey_year", y = "prop", fill = "class_desc",
                  ylabel = "% of respondents", 
                  title = paste0("Displacement by Regional Geogrpahy")) + theme(
                    axis.text.x = element_text(size = 14),
                    axis.text.y = element_text(size = 14),
                    axis.title.y = element_text(size = 20),
                    axis.title.x = element_text(size = 20),
...
# Calculate a categorical summary, i.e. count/share - not working
disp_reggeo2bin <- psrc_hts_stat(hts_data,
                                 analysis_unit="hh",
                                 group_vars=c("class_desc_bin2", "displaced"))

focus_year <- 2023

# create chart
static_column_chart(filter(disp_reggeo2bin, 
                           survey_year == focus_year,
                           displaced=="Displaced"),
...
# All years
static_line_chart(filter(disp_reggeo2bin,
                           displaced=="Displaced"),
                    x = "survey_year", y = "prop", fill = "class_desc_bin2",
                    ylabel = "% of respondents", 
                    title = paste0("Displacement by Regional Geogrpahy")) + theme(
                      axis.text.x = element_text(size = 14),
                      axis.text.y = element_text(size = 14),
