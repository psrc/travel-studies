...
Res duration by previous home in RGC category 2019, 2021
Res duration by current home in RGC category 2019, 2021, 2023

Previous Home RGC category by displaced or not 2019, 2021
Current Home RGC category by displaced or not 2019, 2021, 2023

matrix previous home rgc category-> current home rgc category
2019, 2023
...
static_bar_chart(summary_info, x='prop', y='sexuality', fill='sexuality', moe='prop_moe' )+ theme(axis.text.x=element_text(size=14), axis.text.y=element_text(size=14),legend.text = element_text(size=14), axis.title.y=element_text(size=20), axis.title.x=element_text(size=20))
```
```{r}
summary_info<-summary$summary$wtd%>%mutate(est_moe=est_se*1.645)%>%mutate(sexuality= fct_reorder(sexuality,prop))%>%filter(sexuality!='Heterosexual (straight)')
static_bar_chart(summary_info, x='est', y='sexuality', fill='sexuality', moe='est_moe' )+ theme(axis.text.x=element_text(size=14), axis.text.y=element_text(size=14),legend.text = element_text(size=14), axis.title.y=element_text(size=20), axis.title.x=element_text(size=20))
```
