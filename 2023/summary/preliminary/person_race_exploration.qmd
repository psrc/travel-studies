...
person<- get_query(sql= "select household_id as hh_id, race_category,
                   ...
                   race_category_2023, race_category_2023_b, race_category_2023_c,
...
table1(~race_category_2023_c, data=adult_23)
```
...
```{r, include=FALSE, eval=FALSE}
table(adult_23$race_category_2023_c)
table1(~race_category_2023_c, data = adult_23)

no_missing_race_cat_2023_b <- adult_23 %>% 
  filter(race_category_2023_c!="Missing/No response")
table1(~race_category_2023_c, data = no_missing_race_cat_2023_b)

# spot check - random sample
check_df <- adult_23 %>% 
  dplyr::select(-c(hh_id, race_category, survey_year, person_weight, 
                   gender, age, race_category_2023, race_category_2023_b,  
...
missing_norace_eth <- adult_23 %>% 
  ...
  dplyr::select(race_afam:race_white, starts_with("ethnicity"), race_category_2023_c, person_id)
...
missing_eth <- adult_23 %>% 
  ...
  dplyr::select(race_afam:race_white, race_category_2023_c, person_id)

# how many of that group was classified as "Missing/No response" but had a race chosen?
missing_eth_999 <- missing_eth %>% 
  filter(race_category_2023_c=="Missing/No response") #119
...
missing_eth_afam <- adult_23 %>% 
  ...
  dplyr::select(race_afam:race_white, race_category_2023_c, person_id, ethnicity_999)
...
table1(~race_category_2023_c, data=missing_eth) # mistake - shouldn't have any race categories other than 'missing/no response' because ethnicity_999 was selected for this subgroup of 235 people
...
# table1(~race_category_2023_c, data=missing_both) #to check - result as expected
```

# race_category_2023_c
...
adult_23_simp <- adult_23 %>% 
  select(hh_id, person_id, race_category_2023_c, age) 
...
hh_2people_wider <- combined %>% 
  filter(n_members==2) %>% 
  pivot_wider(names_from = race_category_2023_c, values_from = n_members, values_fill = 0) %>% 
...
combined_race_number <- combined %>% 
  dplyr::mutate(race_num=case_when(race_category_2023_c=="White non-Hispanic"~1,
                                   race_category_2023_c=="Hispanic"~2,
                                   race_category_2023_c=="Black or African American non-Hispanic"~3,
                                   race_category_2023_c=="Asian non-Hispanic"~4,
                                   race_category_2023_c=="Some Other Race non-Hispanic"~5,
                                   race_category_2023_c=="Two or More Races non-Hispanic"~6,
                                   race_category_2023_c=="Missing/No response"~7))
...
```{r}
all_people <- combined %>% 
  dplyr::mutate(person_cat=case_when(race_category_2023_c=="Black or African American non-Hispanic"~"African American",
                                 race_category_2023_c=="Asian non-Hispanic"~"AANHPI",
                                 race_category_2023_c=="Hispanic"~"Hispanic",
                                 race_category_2023_c=="Missing/No response"~"Missing",
                                 race_category_2023_c=="White non-Hispanic"~"White",
                                 race_category_2023_c=="Some Other Race non-Hispanic" |
                                   race_category_2023_c=="Two or More Races non-Hispanic"~"Other"))
...
table1(~race_category_2023_c, data=one_person_hh_nonwhite)
```
...
pivot <- other_hh_race %>% 
  pivot_wider(names_from = race_category_2023_c, values_from = n_members.x, values_fill = 0) %>% 
...
```{r}
# unique(one_person_hh_nonwhite$race_category_2023_c)
# table(one_person_hh_nonwhite$race_category_2023_c)

oneperson_hh_nonwhite_categories <- one_person_hh_nonwhite %>% 
  dplyr::mutate(hh_cat=case_when(race_category_2023_c=="Black or African American non-Hispanic"~"African American",
                                 race_category_2023_c=="Asian non-Hispanic"~"AANHPI",
                                 race_category_2023_c=="Hispanic"~"Hispanic",
                                 race_category_2023_c=="Missing/No response"~"Missing",
                                 race_category_2023_c=="Some Other Race non-Hispanic" |
...
length(unique(twoplus_hh_nonwhite$hh_id)) #960 - households
nrow(twoplus_person_nonwhite) #960 - persons

# getting data in same format as other data sets
colnames(twoplus_hh_nonwhite)
colnames(other_hh_race)

twoplus_hh_nonwhite_categories <- twoplus_hh_nonwhite %>% 
...
# table1(~ hh_cat| race_category_2023_c, data=all_hh)
```
...
# table1(~ hh_cat| race_category_2023_c, data=all_hh_nomissing)
```


# race_category_2023_b
## Person Race > Household Race 
### By race
```{r}
combined
...
```{r}
all_people <- combined %>% 
  dplyr::mutate(person_cat=case_when(race_category_2023_b=="Black or African American non-Hispanic"~"African American",
                                 race_category_2023_b=="Asian non-Hispanic"~"AANHPI",
                                 race_category_2023_b=="Hispanic"~"Hispanic",
                                 race_category_2023_b=="Missing/No response"~"Missing",
                                 race_category_2023_b=="White non-Hispanic"~"White",
                                 race_category_2023_b=="Some Other Race non-Hispanic" |
                                   race_category_2023_b=="Two or More Races non-Hispanic"~"Other"))
...
# check
sum(hh_comp_2plus$n_members.y) #199
```
...
hh_comp_2plus_race_groups
# check
sum(hh_comp_2plus_race_groups$freq) #1014
```
...
```{r}
all_hh_justwhite_categories <- join_justwhite %>% 
  distinct(hh_id) %>% #keep unique hh id - 1970 households
  dplyr::mutate(hh_cat="White") %>% #add field to match other dfs
  inner_join(join_justwhite, by="hh_id", multiple="first") #join to base data to keep all fields
...
### Non-white, 1 person households
```{r}
# unique(one_person_hh_nonwhite$race_category_2023_b)
# table(one_person_hh_nonwhite$race_category_2023_b)

oneperson_hh_nonwhite_categories <- one_person_hh_nonwhite %>% 
  dplyr::mutate(hh_cat=case_when(race_category_2023_b=="Black or African American non-Hispanic"~"African American",
                                 race_category_2023_b=="Asian non-Hispanic"~"AANHPI",
                                 race_category_2023_b=="Hispanic"~"Hispanic",
                                 race_category_2023_b=="Missing/No response"~"Missing",
                                 race_category_2023_b=="Some Other Race non-Hispanic" |
...
# to check
table(oneperson_hh_nonwhite_categories$hh_cat)
nrow(oneperson_hh_nonwhite_categories) #677 - households
length(unique(oneperson_hh_nonwhite_categories$hh_id)) #677 - households
```
...
length(unique(twoplus_hh_nonwhite$hh_id)) #960 - households
nrow(twoplus_person_nonwhite) #1014 - persons
...
### All households
```{r}
colnames(all_hh_justwhite_categories) #1970; 2049 in race_category_2023_c
colnames(oneperson_hh_nonwhite_categories) #677; 652 in race_category_2023_c
colnames(twoplus_hh_nonwhite_categories) #960


all_hh_extra <- rbind(all_hh_justwhite_categories, #1970
                      oneperson_hh_nonwhite_categories, #677
                      twoplus_hh_nonwhite_categories) #960
...
table1(~ hh_cat, data=all_hh)
table1(~ hh_cat| n_members.x, data=all_hh)
# table1(~ hh_cat| race_category_2023_b, data=all_hh)
```
...
table1(~ hh_cat, data=all_hh_nomissing)
table1(~ hh_cat| n_members.x, data=all_hh_nomissing)
# table1(~ hh_cat| race_category_2023_b, data=all_hh_nomissing)
```
