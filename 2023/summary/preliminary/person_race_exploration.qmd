...
* 81.3%: Not of Hispanic/Latino/Spanish origin
* 13.1%: 'Prefer not to answer'
* 3.1%: Mexican, Mexican American, Chicano
* 1.9%: 'Another'
* 0.4%: Puerto Rican
* 0.2%: Cuban
...
# eth1_race <- count_combination_race('ethnicity_group', 1) #4801
eth1_race <- count_combination_race_by_ethnicitiy(1, 'ethnicity_1', 'ethnicity_group')
# eth1_race <- count_combination_race(eth_1, 'ethnicity_group', 1) #4801
```
Of those who selected 1 ethnicity (Not Hispanic/Latino/Spanish origin), 74.2% were white, 16.4% were asian, 2.7% african american, 2.4% white and asian, 1.2% didn't provide an answer, etc. 
