...
For 2023, summarize each variable: commute_freq, telecommute_freq, workplace in it's most disaggregate form.
telework_time

summarize commute_freq by telecommute_freq
summarize telecommute_freq by telework_time
...
static_bar_chart(telecommute_summary, x='prop', y='telecommute_status', fill='survey_year', xlabel='Telecommute Status') +
...
telecommute_summ <- summarize_weighted(hts_data= worker_list,
                               summarize_var = 'telecommute_freq',
                               summarize_by = 'survey_year',
                               id_cols=c('person_id'),
                               wt_cols=c('person_weight'),
