...
* Household education: Both minimum and maximum aggregations
...
\
Model 1 is a better fit than Model 2 according to McFadden, but is a worse fit according to the AIC/BIC values.</span>
\
\
\

#### <span style="color:#009D6A">Example</span> 
<span style="color:#20b2aa"> The influence of residential type changes in model 2, when compared to the full model with all variables. The trend remains the same with Single-family remaining significant, although becoming slightly more explanatory. </span>
...
```{r test important interactions model : analysis}
# documentation about function: https://www.rdocumentation.org/packages/MASS/versions/7.3-52/topics/polr
...
```
\
<span style="color:#20b2aa">This model indicates that of the variables included, higher household vehicle ownership is most associated with: **household licenses, household income, commute frequency (?), household lifecycle, and residential type**.</span>
\
```{r test important interactions model: stargazer table, results='asis', include=FALSE}
