...
Mean.SD_CI(not_home_workers, hhincome_detailed, commute_auto_Distance, hh_wt_2019)
```
...
ggplot(avg_dist_by_race, aes(x=race_category, y=avg_weighted_dist)) + 
  ...
  geom_errorbar(aes(ymin=dist_race_stats$Weighted_avg-dist_race_stats$sd, 
                    ymax=dist_race_stats$Weighted_avg+dist_race_stats$sd), 
                width=.2,
...
Mean.SD_CI(not_home_workers, hhincome_detailed, commute_auto_time, hh_wt_2019)
```
...
ggplot(avg_time_by_race, aes(x=race_category, y=avg_weighted_time)) + 
  ...
  geom_errorbar(aes(ymin=time_race_stats$Weighted_avg-dist_race_stats$sd, 
                    ymax=time_race_stats$Weighted_avg+dist_race_stats$sd), 
                width=.2,
                position=position_dodge(.9))
```
\
