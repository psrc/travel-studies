...
*The post-hoc tests (Tukey HSD and Levene's test) require that the explanatory variables are categorical, not quantitative.* If variables are quantitative there are two options:
