...
sql.person.query<-paste("SELECT household_id,hhsize, final_home_tract, lifecycle, numchildren, numworkers, numadults, employment,hhincome_broad, worker, student,person_id,education, hhincome_detailed,race_category,telecommute_freq, vehicle_count,commute_auto_time,  license, hours_work, age_category, gender, car_share,commute_auto_distance, commute_mode, work_county, age, work_park_type,  survey_year, 
...
hh_wt_2019, hh_wt_revised, hh_wt_combined, workpass FROM HHSurvey.v_persons_2017_2019_in_house")
...
person_day_dist<- dplyr::left_join(person_day_dist, person_df_dis_parcel)
```
```{r}
...
person_day_dist_d$hhincome_mrbroad <- person_day_dist_d$hhincome_detailed
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_broad== 'Prefer not to answer']<-'100,000-$149,999'
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_broad== '$25,000-$49,999']<-'25,000-$99,999'
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_broad== '$50,000-$74,999']<-'25,000-$99,999'
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_broad== '$75,000-$99,999']<-'25,000-$99,999'
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_detailed== '$200,000-$249,999'] <- '$200,000+'
person_day_dist_d$hhincome_mrbroad[person_day_dist_d$hhincome_detailed== '$250,000 or more'] <- '$200,000+'
...
fit_total<- lm(log(1+person_day_dist_d$tot_dist) ~  delivery_pkgs_freq+dayofweek+survey_year+use_toll+ online_shop_time+telework_time+hhincome_detailed+gender+numchildren+numworkers+lifecycle+numadults+employment+student+race_category+vehicle_count+age+work_park_type+car_share+survey_year+benefits_1+benefits_2+benefits_3+benefits_4+workplace+telecommute_freq+workpass+poverty_200+ln_jobs_auto_30+ln_jobs_transit_45+ transit_qt_mile+dist_super+dist_pharm+dist_rest+dist_school+lutype_p+emptot_2+ppricdy2+dist_lbus+dist_ebus+dist_lrt+dist_crt+dist_lrt+dist_park.y, data = person_day_dist_d)

summ(fit_total)

fit_car<-lm(log(1+person_day_dist_d$tot_car_dist) ~   delivery_pkgs_freq+dayofweek+survey_year+use_toll+ online_shop_time+ telework_time+hhincome_detailed+gender+numchildren+numworkers+lifecycle+numadults+employment+student+race_category+vehicle_count+age+work_park_type+car_share+survey_year+benefits_1+benefits_2+benefits_3+benefits_4+workplace+telecommute_freq+workpass+poverty_200+ln_jobs_auto_30+ln_jobs_transit_45+ transit_qt_mile+dist_super+dist_pharm+dist_rest+dist_school+lutype_p+emptot_2+ppricdy2+dist_lbus+dist_ebus+dist_lrt+dist_crt+dist_lrt+dist_park.y, data = person_day_dist_d)

summ(fit_car)


fit_transit<- lm(log(1+person_day_dist_d$tot_transit_dist) ~delivery_pkgs_freq+dayofweek+survey_year+use_toll+ online_shop_time+ telework_time+hhincome_detailed+gender+numchildren+numworkers+lifecycle+numadults+employment+student+race_category+vehicle_count+age+work_park_type+car_share+survey_year+benefits_1+benefits_2+benefits_3+benefits_4+workplace+telecommute_freq+workpass+poverty_200+ln_jobs_auto_30+ln_jobs_transit_45+ transit_qt_mile+dist_super+dist_pharm+dist_rest+dist_school+lutype_p+emptot_2+ppricdy2+dist_lbus+dist_ebus+dist_lrt+dist_crt+dist_lrt+dist_park.y,  data = person_day_dist_d)
        



fit_walk_bike<- lm(log(1+person_day_dist_d$tot_walk_bike_dist) ~delivery_pkgs_freq+dayofweek+survey_year+use_toll+ online_shop_time+ telework_time+hhincome_detailed+gender+numchildren+numworkers+lifecycle+numadults+employment+student+race_category+vehicle_count+age+work_park_type+car_share+survey_year+benefits_1+benefits_2+benefits_3+benefits_4+workplace+telecommute_freq+workpass+poverty_200+ln_jobs_auto_30+ln_jobs_transit_45+ transit_qt_mile+dist_super+dist_pharm+dist_rest+dist_school+lutype_p+emptot_2+ppricdy2+dist_lbus+dist_ebus+dist_lrt+dist_crt+dist_lrt+dist_park.y,  data = person_day_dist_d)
